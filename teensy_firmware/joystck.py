...
class XboxController(object):
    ...
    def read(self): # return the buttons/triggers that you care about in this methode
        ...
        # Control scheme:
        # Left joy stick x = move forward
        # Left joy stick y = turn
        # Right joy stick x = excavation
        # X/B = linear actuators retract/extend
        # A = vib toggle
        # Y = hop latch
        ...
        vib = self.A
        hop_latch = self.Y
        return [x, y, excav, la_extend, la_retract, vib, hop_latch]
        ...
        while True:
            ...
            for event in events:
                if event.code == 'ABS_Y':
                    ...
                    self.B = event.state #previously switched with X
